...
ETH_SYNCING=$(curl -s -X POST --data '{"jsonrpc":"2.0","method":"eth_syncing","params":[],"id":710}' http://localhost:8332 -H 'Content-Type: application/json')
ETH_PEER=$(curl -s -X POST --data '{"jsonrpc":"2.0","method":"net_peerCount","params":[],"id":710}' http://localhost:8332 -H 'Content-Type: application/json')
